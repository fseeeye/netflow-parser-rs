use parsing_parser::{L5Packet, ApplicationLayer, parsers::fins_tcp_req};
use serde::{Serialize, Deserialize};

use crate::{detect::IcsRuleDetector, detect_option_eq, detect_address};
            ...
            if let fins_tcp_req::State::Connected { fh} = &fins_req.state {
                ...
                match self.command_data {
                    ...
                    FinsCommandData::MultipleMemoryAreaRead {
                        ...
                        start_address,
                        end_address
                    } => if let fins_tcp_req::Order::MultipleMemoryAreaRead {
                        result: results
                    } = &fh.cmd_type.order {
                        for result in results {
                            detect_option_eq!(code, result.memory_area_code as u16);
                            detect_address!(start_address, end_address, result.beginning_address as u32);
                        }
                    } else {
                        return false
                    },
                    ...
                    FinsCommandData::DataLinkTableRead {} => if let fins_tcp_req::Order::DataLinkTableRead { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::DataLinkTableWrite {} => if let fins_tcp_req::Order::DataLinkTableWrite { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::ProgramAreaProtect {} => if let fins_tcp_req::Order::ProgramAreaProtect { 
                        ..
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::ProgramAreaProtectClear {} => if let fins_tcp_req::Order::ProgramAreaProtectClear { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::ProgramAreaRead {} => if let fins_tcp_req::Order::ProgramAreaRead { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::ProgramAreaWrite {} => if let fins_tcp_req::Order::ProgramAreaWrite { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::ProgramAreaClear {} => if let fins_tcp_req::Order::ProgramAreaClear { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::Run { code } => if let fins_tcp_req::Order::Run { 
                        mode_code,
                        .. 
                    } = fh.cmd_type.order {
                    ...
                    FinsCommandData::Stop {} => if let fins_tcp_req::Order::Stop { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::Reset {} => if let fins_tcp_req::Order::Reset { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::ControllerDataRead {} => if let fins_tcp_req::Order::ControllerDataRead { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::ConnectionDataRead {} => if let fins_tcp_req::Order::ConnectionDataRead { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::ControllerStatusRead {} => if let fins_tcp_req::Order::ControllerStatusRead { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::NetworkStatusRead {} => if let fins_tcp_req::Order::NetworkStatusRead { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::DataLinkStatusRead {} => if let fins_tcp_req::Order::DataLinkStatusRead { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::CycleTimeRead {} => if let fins_tcp_req::Order::CycleTimeRead { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::ClcokRead {} => if let fins_tcp_req::Order::ClcokRead { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::ClcokWrite {} => if let fins_tcp_req::Order::ClcokWrite { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::LoopBackTest {} => if let fins_tcp_req::Order::LoopBackTest { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::BroadcastTestResultsRead {} => if let fins_tcp_req::Order::BroadcastTestResultsRead { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::BroadcastTestDataSend {} => if let fins_tcp_req::Order::BroadcastTestDataSend { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::MessageReadClearFALSRead {} => if let fins_tcp_req::Order::MessageReadClearFALSRead { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::AccessRightAcquire {} => if let fins_tcp_req::Order::AccessRightAcquire { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::AccessRightForcedAcquire {} => if let fins_tcp_req::Order::AccessRightForcedAcquire { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::AccessRightRelease {} => if let fins_tcp_req::Order::AccessRightRelease { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::ErrorClear {} => if let fins_tcp_req::Order::ErrorClear { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::ErrorLogRead {} => if let fins_tcp_req::Order::ErrorLogRead { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::ErrorLogClear {} => if let fins_tcp_req::Order::ErrorLogClear { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::FileNameRead {} => if let fins_tcp_req::Order::FileNameRead { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::SingleFileRead {} => if let fins_tcp_req::Order::SingleFileRead { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::SingleFileWrite {} => if let fins_tcp_req::Order::SingleFileWrite { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::MemoryCardFormat {} => if let fins_tcp_req::Order::MemoryCardFormat { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::FileDelete {} => if let fins_tcp_req::Order::FileDelete { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::VolumeLabelCreateOrDelete {} => if let fins_tcp_req::Order::VolumeLabelCreateOrDelete { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::FileCopy {} => if let fins_tcp_req::Order::FileCopy { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::FileNameChange {} => if let fins_tcp_req::Order::FileNameChange { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::FileDataCheck {} => if let fins_tcp_req::Order::FileDataCheck { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::MemoryAreaFileTransfer {} => if let fins_tcp_req::Order::MemoryAreaFileTransfer { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::ParameterAreaFileTransfer {} => if let fins_tcp_req::Order::ParameterAreaFileTransfer { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::ProgramAreaFileTransfer {} => if let fins_tcp_req::Order::ProgramAreaFileTransfer { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::FileMemoryIndexRead {} => if let fins_tcp_req::Order::FileMemoryIndexRead { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::FileMemoryRead {} => if let fins_tcp_req::Order::FileMemoryRead { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::FileMemoryWrite {} => if let fins_tcp_req::Order::FileMemoryWrite { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::ForcedSetOrReset {} => if let fins_tcp_req::Order::ForcedSetOrReset { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::ForcedSetOrResetCancel {} => if let fins_tcp_req::Order::ForcedSetOrResetCancel { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    ...
                    FinsCommandData::NameSet {} => if let fins_tcp_req::Order::NameSet { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::NameDelete {} => if let fins_tcp_req::Order::NameDelete { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                    FinsCommandData::NameRead {} => if let fins_tcp_req::Order::NameRead { 
                        .. 
                    } = fh.cmd_type.order {} else { return false },
                }
            }
