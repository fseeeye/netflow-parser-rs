...
pub fn parsers_map_init() -> ParsersMap {
    ...
    parsers_map.insert(LayerType::Eof, Box::new(crate::parsers::parse_eof_layer));
    parsers_map.insert(LayerType::Ethernet, Box::new(crate::parsers::parse_ethernet_layer));
    parsers_map.insert(LayerType::Ipv4, Box::new(crate::parsers::parse_ipv4_layer));
    parsers_map.insert(LayerType::Ipv6, Box::new(crate::parsers::parse_ipv6_layer));
    parsers_map.insert(LayerType::ModbusReq, Box::new(crate::parsers::parse_modbus_req_layer));
    parsers_map.insert(LayerType::ModbusRsp, Box::new(crate::parsers::parse_modbus_rsp_layer));
    parsers_map.insert(LayerType::Tcp, Box::new(crate::parsers::parse_tcp_layer));
    parsers_map.insert(LayerType::Udp, Box::new(crate::parsers::parse_udp_layer));
